...
translations = {
    ...
    'EN': {
        ...
        'hero_1': 'Check before an',
        'hero_2': 'allergic reaction',
        ...
        'scan_title':
            'Take a photo. We’ll handle the rest.',
...
def normalize_allergies(allergies):
    ...
    for allergy in allergies:
        ...
        new_name = ALLERGY_ALIASES.get(
            allergy,
            allergy
        )

        if (
            new_name in ALLERGIES
            and new_name not in normalized
        ):
            normalized.append(
                new_name
            )
...
def allergy_label(allergy):
    ...
    allergy = ALLERGY_ALIASES.get(
        allergy,
        allergy
    )

    return ALLERGY_LABELS[
        st.session_state.language
    ].get(
        allergy,
        allergy
...
# =========================================================
    ...
    if st.session_state.page not in current_map:
        st.session_state.page = 'scan'
    ...
    if st.session_state.page == 'scan':
        ...
        my_allergies = normalize_allergies(
            get_user_allergies(
                user['id']
            )
        )
        ...
        for member in family:
            ...
            member_allergies = normalize_allergies(
                member['allergies']
            )
            ...
            for index, member in enumerate(
                ...
                with columns[
                    ...
                    with st.container(
                        ...
                        normalized_member_allergies = normalize_allergies(
                            member['allergies']
                        )
                        ...
                        pills = ''.join(
                            ...
                            for allergy
                            in normalized_member_allergies
                        )
